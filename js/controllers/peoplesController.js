materialAdmin
    ...
    .controller('peoplesCtrl', function($filter, $timeout, $stateParams, $state, $scope, ngTableParams, httpRequest, API_URL) {

    var self = this;
    self.lang = $stateParams.lang;

    var url = API_URL.url + 'people' + '/' + self.lang;
        ...
        .then(
            function(result) {
                var data = result;
                    ...
                    // console.log(data);
                    self.tablePeople = new ngTableParams({
